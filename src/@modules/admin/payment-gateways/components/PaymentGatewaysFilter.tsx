...
import { IPaymentGatewaysFilter } from '../lib/interfaces';

interface IProps {
  initialValues: IPaymentGatewaysFilter;
  onChange: (values: IPaymentGatewaysFilter) => void;
}

const PaymentGatewaysFilter: React.FC<IProps> = ({ initialValues, onChange }) => {
...
export default PaymentGatewaysFilter;
