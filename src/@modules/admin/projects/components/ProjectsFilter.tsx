...
import { IProjectsFilter } from '../lib/interfaces';

interface IProps {
  initialValues: IProjectsFilter;
  onChange: (values: IProjectsFilter) => void;
}

const ProjectsFilter: React.FC<IProps> = ({ initialValues, onChange }) => {
