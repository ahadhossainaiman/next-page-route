...
import { IInvestmentsFilter } from '../lib/interfaces';

interface IProps {
  initialValues: IInvestmentsFilter;
  onChange: (values: IInvestmentsFilter) => void;
}

const InvestmentsFilter: React.FC<IProps> = ({ initialValues, onChange }) => {
