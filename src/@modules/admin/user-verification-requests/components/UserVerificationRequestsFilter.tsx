...
import { IUserVerificationRequestsFilter } from '../lib/interfaces';

interface IProps {
  initialValues: IUserVerificationRequestsFilter;
  onChange: (values: IUserVerificationRequestsFilter) => void;
}

const UserVerificationRequestsFilter: React.FC<IProps> = ({ initialValues, onChange }) => {
...
export default UserVerificationRequestsFilter;
