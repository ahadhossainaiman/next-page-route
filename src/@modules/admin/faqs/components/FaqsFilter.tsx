...
import { IFaqsFilter } from '../lib/interfaces';

interface IProps {
  initialValues: IFaqsFilter;
  onChange: (values: IFaqsFilter) => void;
}

const FaqsFilter: React.FC<IProps> = ({ initialValues, onChange }) => {
