  ...
  return (
    <div className="flex flex-col items-center gap-4">
      <div className="text-center">
        ...
        <p className="text-gray-300">Enter the {otpCount} digit code which sent to your email</p>
      </div>
      <div className="flex flex-wrap justify-center items-center gap-2">
        {Array.from({ length: otpCount }).map((_, idx) => (
          <input
            ...
            className="w-8 h-8 text-center border border-gray-300 focus-visible:outline-[var(--color-primary)] rounded-full [appearance:textfield] [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none text-[var(--color-primary)]"
          />
        ))}
      </div>
      <span>
