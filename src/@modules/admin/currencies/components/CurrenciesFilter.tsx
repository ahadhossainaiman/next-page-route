...
import { ICurrenciesFilter } from '../lib/interfaces';

interface IProps {
  initialValues: ICurrenciesFilter;
  onChange: (values: ICurrenciesFilter) => void;
}

const CurrenciesFilter: React.FC<IProps> = ({ initialValues, onChange }) => {
