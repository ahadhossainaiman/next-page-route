...
import { IFaqCategoriesFilter } from '../lib/interfaces';

interface IProps {
  initialValues: IFaqCategoriesFilter;
  onChange: (values: IFaqCategoriesFilter) => void;
}

const FaqCategoriesFilter: React.FC<IProps> = ({ initialValues, onChange }) => {
...
export default FaqCategoriesFilter;
