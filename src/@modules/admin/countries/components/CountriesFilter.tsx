...
import { ICountriesFilter } from '../lib/interfaces';

interface IProps {
  initialValues: ICountriesFilter;
  onChange: (values: ICountriesFilter) => void;
}

const CountriesFilter: React.FC<IProps> = ({ initialValues, onChange }) => {
